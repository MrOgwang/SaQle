...
class Config{
	 ...
	 public function __construct(...$settings){
	 	 ...
	 	 * */
	 	define("config('enable_rbac')", $settings['enable_rbac'] ?? false);
	 	define("config('role_model_class')", $settings['role_model_class'] ?? BaseRole::class);
	 	define("config('permission_model_class')", $settings['permission_model_class'] ?? BasePermission::class);
	 	
	 	/**
	 	 * Array of all the db context classes.
	 	 * */
	 	define("config('db_context_classes')", $settings['config('db_context_classes')'] ?? []);
		  ...
		  * */
	     define("config('installed_apps')", $settings['installed_apps'] ?? []);
		 ...
		 * */
		 define("config('auth_model_class')", $settings['auth_model_class'] ?? BaseUser::class);
		  ...
		  * */
		 define("config('tenant_model_class')", $settings['tenant_model_class'] ?? BaseTenant::class);
		 define("config('enable_multitenancy')", $settings['enable_multitenancy'] ?? false);
		 ...
		 * */
		  ...
		  * if that need arises.
		  * */
		 define("config('model_auto_cm_fields')", $settings['model_auto_cm_fields'] ?? false);
		 ...
		 define("config('model_auto_cmdt_fields')", $settings['model_auto_cmdt_fields'] ?? false);
		 ...
		 define("config('model_soft_delete')", $settings['model_soft_delete'] ?? false);
          ...
          * 
          * */
		 define("config('model_action_on_duplicate')", $settings['model_action_on_duplicate'] ?? 'ABORT_WITH_ERROR');
