...
class TargetCompiler{
     ...
     protected array $controllerrefs;

     protected array $templaterefs;

     protected string $projectroot;

     public function __construct(string $projectroot){
         $this->projectroot = $projectroot;
         $this->controllerrefs = require_once $this->projectroot.CLASS_MAPPINGS_DIR."controllers.php";
         $this->templaterefs = require_once $this->projectroot.CLASS_MAPPINGS_DIR."views.php";
     }
