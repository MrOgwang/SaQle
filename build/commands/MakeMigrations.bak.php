...
class MakeMigrations {
     ...
     private function get_schema_snapshot($timestamp, $migration_name, $tracker){
     ...
     private function make_migrations(string $type, $timestamp, $migration_name){
         ...
         [$snapshot, $snapshot_records] = $this->get_schema_snapshot($timestamp, $migration_name, $tracker);
     ...
     public function execute($migration_name){
         ...
         $this->make_migrations('system', $timestamp, $migration_name);
         $this->make_migrations('tenant', $timestamp, $migration_name);
     }
}
