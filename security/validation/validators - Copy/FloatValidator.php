...
/**
 * The float validator checks that the value is of type float.
 * 
 * @pacakge SaQle
...
class FloatValidator extends IValidator {
	 ...
	 public function validate(string $field, mixed $value, mixed $threshold = null, array $context = []) : ValidationResult {
	 	 ...
	 	 $isvalid = settype($value, "float") ? true : false;
	 	 return new ValidationResult(
             isvalid: $isvalid,
             message: $isvalid ? null : "The value provided is not a float!"
         );
