...
/**
 * Maximum date and time validator
 * 
 * @pacakge SaQle
...
class MaxDateTimeValidator extends AbstractDateTimeValidator {
     use DateValidationHelper;

     public function validate(mixed $value, array $context = []): ValidationResult {
         return $this->validate_temporal("max", $value, $context);
     }

     public function message() : string {
         return "{$this->field} must not exceed {$this->threshold}";
     }
}
