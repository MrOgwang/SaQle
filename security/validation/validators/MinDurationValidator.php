...
/**
 * Video minimum duration validator
 * 
 * @pacakge SaQle
...
class MinDurationValidator extends IValidator {
     ...
     public function validate(mixed $value, array $context = []): ValidationResult {
	     ...
	     if($duration < $this->threshold){
	         return new ValidationResult(false, "{$this->field} duration must be at least {$this->threshold} seconds.");
	     }
