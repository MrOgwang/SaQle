...
/**
 * Checks if an input is a valid url
 * 
 * @pacakge SaQle
...
class UrlValidator extends ValidatorDecorator{
	 use ScalarValidator;
	 ...
	 public function validate($input, $config, $code, $message = null){
		 $feedback = $this->execute_next_validator($input, $config, $code, $message);
	 	 $this->validate_scalar($feedback, [$this, 'is_url_valid']);
		 return $feedback;
	 }
	 public function is_url_valid($input, $config){
		 return [
		     'is_valid' => true, 
