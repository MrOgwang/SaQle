		 ...
		 foreach($properties as $p){
	         ...
	         $row_label        = ucwords(str_replace("_", " ", $fn_sproperty));
		 	 ...
		 	 if(!$fn_key_instance->get_multiple()){
		 	 	$rows = array_merge($rows, $this->extract_view_rows_from_dao($fmodel, $context, $sdata ? $sdata->$fn_sproperty : $sdata, $sdata, $gindex));
		 	 ...
		 	 $name_property   = $fmodel_instance->get_name_property();
