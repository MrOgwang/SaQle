...
function set_accept_headers(){
	 ...
	 $allowed_origins = array(
		 rtrim(ROOT_DOMAIN, "/"),
		 //rtrim(APP_DOMAINS['pos'], "/"),
		 //rtrim(APP_DOMAINS['inventory'], "/")
	 );
...
require_once REGISTRATION_M . "/auth_m.php";
require_once REGISTRATION_M . "/accounts.php";
...
session_start();
abstract class AjaxRequestHandler implements Observable\Observable{
