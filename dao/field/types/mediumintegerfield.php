...
class MediumIntegerField extends NumberType implements IField{
	public function __construct(...$kwargs){
		...
		$kwargs['max']      = isset($kwargs['max']) ? $kwargs['max'] : ($kwargs['absolute'] ? 16777215 : 8388607);
		$kwargs['min']      = isset($kwargs['min']) ? $kwargs['min'] : ($kwargs['absolute'] ? 0 : -8388608);
